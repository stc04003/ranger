...
namespace ranger {
  ...
  // This is used in ranger forest
  // num_samples is mtry
  void drawWithoutReplacement(std::vector<size_t>& result,
			      std::mt19937_64& random_number_generator, size_t max,
			      size_t num_samples) {
    // std::cout << "draw without replacement \n";
    // std::cout << "num_samples: " << num_samples << "\n";
    // std::cout << "max / 10: " << max / 10 << "\n";
  ...
  void drawWithoutReplacementSimple(std::vector<size_t>& result,
    ...
    // std::cout << "draw without replacement simple\n";
